# Example usage:
#   ARCH := SM80 | SM90 | SM100 | SM103 | SM120 | SM121
#   SRC := kernel.cu
#   OUT := kernel
#   CMD := ./kernel
...
ARCH ?= NOT_SET # SM80 | SM90 | SM100 | SM103 | SM120 | SM121
...
ifeq ($(ARCH),NOT_SET)
$(error ARCH is not set. Please set ARCH to SM80, SM90, SM100, SM103, SM120, or SM121)
endif
ifeq ($(SRC),NOT_SET)
...
ifeq ($(ARCH),SM121)
NVCCFLAGS += -DKITTENS_SM120 -gencode arch=compute_121,code=sm_121
