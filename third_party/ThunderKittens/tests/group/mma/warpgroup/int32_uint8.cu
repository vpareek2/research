...
void group::mma::warpgroup::int32_uint8::tests(test_data &results) {
    ...
    mma_wrapper_2d<test_mma_ABt_int32_uint8, 4, 16, 4, I2_t>::run(results);
    mma_wrapper_2d<test_mma_ABt_int32_uint8, 4, 16, 4, I4_t>::run(results);
    mma_wrapper_2d<reg_test_mma_ABt_int32_uint8, 4, 16, 4, I2_t>::run(results);
    mma_wrapper_2d<reg_test_mma_ABt_int32_uint8, 4, 16, 4, I4_t>::run(results);
    std::cout << std::endl;
}
