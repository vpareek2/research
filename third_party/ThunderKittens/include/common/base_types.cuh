...
template<> struct packing<char> {
    ...
    static __device__ inline constexpr int8_4 pack(const char &i) { return int8_4{static_cast<int8>(i), static_cast<int8>(i), static_cast<int8>(i), static_cast<int8>(i)}; } // this replication makes code cleaner later.
};
